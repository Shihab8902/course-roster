...
const Icons = ({ credit_hour, price }) => {
    return <div className='flex items-center gap-4 mt-4'>
        ...
        <div className='flex items-center'>
            ...
            <p className='ml-1 text-[#1C1B1B99] text-sm font-medium'>Price : {price}</p>
        </div>
        ...
        <div className='flex items-center'>
            ...
            <p className='ml-2 text-[#1C1B1B99] text-sm font-medium'>Credit : {credit_hour}hr</p>
        </div>
